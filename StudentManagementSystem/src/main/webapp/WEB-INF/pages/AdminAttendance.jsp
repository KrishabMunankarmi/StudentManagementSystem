...
<div class="admin-content">
    ...
    <div class="form-card">
        ...
        <form method="post" action="${pageContext.request.contextPath}/adminattendancepage" class="admin-form">
    ...
    <div class="table-container">
        <table class="admin-table">
            <thead>
                <tr><th>Student</th><th>Subject</th><th>Attended</th><th>Total</th><th>Percentage</th><th>Actions</th></tr>
            </thead>
...
if (attendance.length === 0) {
    ...
    attendance.forEach(function(a) {
        ...
        tbody.innerHTML += "<tr><td>" + a.name + "</td><td>" + a.subject_name + "</td><td>" +
            a.attended + "</td><td>" + a.total_classes + "</td><td>" + a.percentage + "%" + flag + "</td>" +
            "<td><form method='post' action='${pageContext.request.contextPath}/adminattendancepage'>" +
